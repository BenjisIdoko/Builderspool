...
- [ ] Run `npx prisma migrate dev --name init` against a real Neon/Supabase database (schema is validated and generates clean, but no migration has been applied to any real database yet)
