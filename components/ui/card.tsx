...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // Hairline border, not a shadow/ring — see the Design Direction
        // section in BUILDERSPOOL_PROJECT_BRIEF.md ("hairline borders over
        // shadows" is a deliberate anti-"AI slop" decision).
