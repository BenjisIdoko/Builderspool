...
export function ProductDetailPanel({
  ...
  return (
    <div>
      ...
      {material.spec && (
        <div className="mb-8">
          <h2 className="mb-3 text-sm font-bold text-slate">Description</h2>
      ...
      {hasDetails && (
        <div className="mb-8">
          <h2 className="mb-3 text-sm font-bold text-slate">Details</h2>
      ...
      <div className="rounded-lg border border-border p-4">
        ...
        <p className="mb-3 text-xs text-muted-foreground">
          We&apos;ll save this — there&apos;s no email/SMS alerting yet, so check back here to see if it&apos;s been
          reached.
        </p>
