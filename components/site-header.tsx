...
export async function SiteHeader() {
  ...
  return (
    ...
    <div className="fixed inset-x-0 top-4 z-50 px-4 sm:px-6">
      <header className="mx-auto flex max-w-6xl items-center justify-between gap-4 rounded-full border border-border/70 bg-surface/85 px-3.5 py-8 shadow-[0_12px_32px_rgba(15,23,42,0.08),0_2px_6px_rgba(15,23,42,0.04)] backdrop-blur-[14px] sm:gap-6 sm:px-4.5">
